...
procedure FMAMatrixMultAlignedTransposed(dest : PDouble; const destLineWidth : TASMNativeInt; mt1, mt2 : PDouble; width1 : TASMNativeInt; height1 : TASMNativeInt; width2 : TASMNativeInt; height2 : TASMNativeInt; const LineWidth1, LineWidth2 : TASMNativeInt); {$IFDEF FPC} assembler; {$ELSE} register; {$ENDIF}
procedure FMAMatrixMultAlignedEvenW1EvenH2TransposedMod16(dest : PDouble; const destLineWidth : TASMNativeInt; mt1, mt2 : PDouble; width1 : TASMNativeInt; height1 : TASMNativeInt; width2 : TASMNativeInt; height2 : TASMNativeInt; const LineWidth1, LineWidth2 : TASMNativeInt); {$IFDEF FPC} assembler; {$ELSE} register; {$ENDIF}
procedure FMAMatrixMultAlignedEvenW1OddH2TransposedMod16(dest : PDouble; const destLineWidth : TASMNativeInt; mt1, mt2 : PDouble; width1 : TASMNativeInt; height1 : TASMNativeInt; width2 : TASMNativeInt; height2 : TASMNativeInt; const LineWidth1, LineWidth2 : TASMNativeInt); {$IFDEF FPC} assembler; {$ELSE} register; {$ENDIF}
procedure FMAMatrixMultUnAlignedTransposed(dest : PDouble; const destLineWidth : TASMNativeInt; mt1, mt2 : PDouble; width1 : TASMNativeInt; height1 : TASMNativeInt; width2 : TASMNativeInt; height2 : TASMNativeInt; const LineWidth1, LineWidth2 : TASMNativeInt); {$IFDEF FPC} assembler; {$ELSE} register; {$ENDIF}
   ...
   @@forylabel:
       ...
       @@fory2label:
           ...
           @@InnerLoop:
               ...
               {$IFDEF FPC}vfmadd231pd ymm0, ymm1, [edi + edx];{$ELSE}db $C4,$E2,$F5,$B8,$04,$17;{$ENDIF} 
               {$IFDEF FPC}vfmadd231pd ymm2, ymm1, [esi + edx];{$ELSE}db $C4,$E2,$F5,$B8,$14,$16;{$ENDIF} 

               {$IFDEF FPC}vmovapd ymm1, [ecx + edx + 32];{$ELSE}db $C5,$FD,$28,$4C,$11,$20;{$ENDIF} 

               // multiply 2x2 and add
               {$IFDEF FPC}vfmadd231pd ymm0, ymm1, [edi + edx + 32];{$ELSE}db $C4,$E2,$F5,$B8,$44,$17,$20;{$ENDIF} 
               {$IFDEF FPC}vfmadd231pd ymm2, ymm1, [esi + edx + 32];{$ELSE}db $C4,$E2,$F5,$B8,$54,$16,$20;{$ENDIF} 

               {$IFDEF FPC}vmovapd ymm1, [ecx + edx + 64];{$ELSE}db $C5,$FD,$28,$4C,$11,$40;{$ENDIF} 

               // multiply 2x2 and add
               {$IFDEF FPC}vfmadd231pd ymm0, ymm1, [edi + edx + 64];{$ELSE}db $C4,$E2,$F5,$B8,$44,$17,$40;{$ENDIF} 
               {$IFDEF FPC}vfmadd231pd ymm2, ymm1, [esi + edx + 64];{$ELSE}db $C4,$E2,$F5,$B8,$54,$16,$40;{$ENDIF} 


               {$IFDEF FPC}vmovapd ymm1, [ecx + edx + 96];{$ELSE}db $C5,$FD,$28,$4C,$11,$60;{$ENDIF} 

               // multiply 2x2 and add
               {$IFDEF FPC}vfmadd231pd ymm0, ymm1, [edi + edx + 96];{$ELSE}db $C4,$E2,$F5,$B8,$44,$17,$60;{$ENDIF} 
               {$IFDEF FPC}vfmadd231pd ymm2, ymm1, [esi + edx + 96];{$ELSE}db $C4,$E2,$F5,$B8,$54,$16,$60;{$ENDIF} 
   ...
   @@forylabel:
       ...
       @@fory2label:
           ...
           @@InnerLoop:
               ...
               {$IFDEF FPC}vmovupd ymm4, [esi + edx - 32];{$ELSE}db $C5,$FD,$10,$64,$16,$E0;{$ENDIF} 
   ...
   @@forylabel:
       ...
       @@fory2label:
           ...
           @@InnerLoop:
               ...
               // multiply 2x2 and add
               {$IFDEF FPC}vfmadd231pd ymm0, ymm1, [edi + edx - 32];{$ELSE}db $C4,$E2,$F5,$B8,$44,$17,$E0;{$ENDIF} 
               {$IFDEF FPC}vfmadd231pd ymm2, ymm1, [esi + edx - 32];{$ELSE}db $C4,$E2,$F5,$B8,$54,$16,$E0;{$ENDIF} 
