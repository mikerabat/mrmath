...
asm
   ...
   @@foryloop:
       ...
       @@forxloop:
           ...
           {$IFDEF AVXSUP}vfmadd231pd ymm0, ymm4, [ecx];              {$ELSE}db $C4,$E2,$DD,$B8,$01;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm1, ymm4, [ecx + esi];        {$ELSE}db $C4,$E2,$DD,$B8,$0C,$31;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm2, ymm4, [ecx + 2*esi];      {$ELSE}db $C4,$E2,$DD,$B8,$14,$71;{$ENDIF} 

           add ecx, esi;
           {$IFDEF AVXSUP}vfmadd231pd ymm3, ymm4, [ecx + 2*esi];      {$ELSE}db $C4,$E2,$DD,$B8,$1C,$71;{$ENDIF} 
           sub ecx, esi;
...
asm
   ...
   @@forxloop:
       ...
       @@foryloop:
           ...
           {$IFDEF AVXSUP}vfmadd231pd ymm1, ymm3, ymm4;               {$ELSE}db $C4,$E2,$E5,$B8,$CC;{$ENDIF} 
...
asm
   ...
   @@foryloop:
      ...
      @@forxloop:
         ...
         // pA^[j] := pA^[j] + tmp*pY1^[j];
         {$IFDEF AVXSUP}vfmadd231pd ymm1, ymm2, ymm0;                 {$ELSE}db $C4,$E2,$ED,$B8,$C8;{$ENDIF} 
      ...
      {$IFDEF AVXSUP}vfmadd231pd xmm1, xmm2, xmm0;                    {$ELSE}db $C4,$E2,$E9,$B8,$C8;{$ENDIF} 
...
asm
   ...
   @@foryloop:
      ...
      @@forxloop:
         ...
         // pA^[j] := pA^[j] + tmp*pY1^[j];
         {$IFDEF AVXSUP}vfmadd231pd ymm1, ymm0, [ebx];                {$ELSE}db $C4,$E2,$FD,$B8,$0B;{$ENDIF} 
      ...
      {$IFDEF AVXSUP}vfmadd231pd xmm1, xmm0, [ebx];                   {$ELSE}db $C4,$E2,$F9,$B8,$0B;{$ENDIF} 
