   ...
   @@forylabel:
       ...
       @@fory2label:
           ...
           @@InnerLoop:
               ...
               {$IFDEF AVXSUP}vmulpd ymm3, ymm1, [edi + edx];         {$ELSE}db $C5,$F5,$59,$1C,$17;{$ENDIF} 
               {$IFDEF AVXSUP}vmulpd ymm4, ymm1, [esi + edx];         {$ELSE}db $C5,$F5,$59,$24,$16;{$ENDIF} 
               ...
               // multiply 2x2 and add
               {$IFDEF AVXSUP}vmulpd ymm3, ymm1, [edi + edx + 32];    {$ELSE}db $C5,$F5,$59,$5C,$17,$20;{$ENDIF} 
               {$IFDEF AVXSUP}vmulpd ymm4, ymm1, [esi + edx + 32];    {$ELSE}db $C5,$F5,$59,$64,$16,$20;{$ENDIF} 
               ...
               // multiply 2x2 and add
               {$IFDEF AVXSUP}vmulpd ymm3, ymm1, [edi + edx + 64];    {$ELSE}db $C5,$F5,$59,$5C,$17,$40;{$ENDIF} 
               {$IFDEF AVXSUP}vmulpd ymm4, ymm1, [esi + edx + 64];    {$ELSE}db $C5,$F5,$59,$64,$16,$40;{$ENDIF} 
               ...
               // multiply 2x2 and add
               {$IFDEF AVXSUP}vmulpd ymm3, ymm1, [edi + edx + 96];    {$ELSE}db $C5,$F5,$59,$5C,$17,$60;{$ENDIF} 
               {$IFDEF AVXSUP}vmulpd ymm4, ymm1, [esi + edx + 96];    {$ELSE}db $C5,$F5,$59,$64,$16,$60;{$ENDIF} 
   ...
   @@forylabel:
       ...
       @@fory2label:
           ...
           @@InnerLoop:
               ...
               // multiply 2x2 and add
               {$IFDEF AVXSUP}vmulpd ymm3, ymm1, [edi + edx - 32];    {$ELSE}db $C5,$F5,$59,$5C,$17,$E0;{$ENDIF} 
               {$IFDEF AVXSUP}vmulpd ymm4, ymm1, [esi + edx - 32];    {$ELSE}db $C5,$F5,$59,$64,$16,$E0;{$ENDIF} 
...
asm
   ...
   @@forylabel:
       ...
       @@LastLineInnerLoop:
            ...
            // load block
            {$IFDEF AVXSUP}vmovapd ymm3, [edi + edx - 32];            {$ELSE}db $C5,$FD,$28,$5C,$17,$E0;{$ENDIF} 
