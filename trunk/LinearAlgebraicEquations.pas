...
function MatrixGaussJordanInPlace(A : PDouble; const LineWidthA : integer; B : PDouble; const LineWidthB : integer; width : integer;
                                  m : integer; const epsilon : double = 1e-20) : TLinEquResult;
...
function MatrixGaussJordan(A : PDouble; const LineWidthA : integer; B : PDouble; const LineWidthB : integer;
                           ...
                           width : integer; m : integer; const epsilon : double = 1e-20) : TLinEquResult;
...
// parity contains -1 or +1 depending wheather the number of row interchanges was even or odd, respectively.
function MatrixLUDecompInPlace(A : PDouble; const LineWidthA : Integer; width : integer; indx : PIntegerArray) : TLinEquResult;
function MatrixLUDecomp(A : PDouble; const LineWidthA : integer; LUDecomp : PDouble; const LineWidthLU : integer; width : integer; indx : PIntegerArray) : TLinEquResult; overload;
function MatrixLUDecomp(A : PDouble; const LineWidthA : integer; LUDecomp : PDouble; const LineWidthLU : integer; width : integer) : TLinEquResult; overload;
procedure MatrixLUBackSubst(LUDecomp : PDouble; const LineWidthLU : integer; width : integer; const  indx : PIntegerArray; B : PDouble; const LineWidthB : integer);

// inverse of a matrix by using the LU decomposition
function MatrixInverseInPlace(A : PDouble; const LineWidthA : integer; width : integer) : TLinEquResult;
...
function MatrixDeterminant(A : PDouble; const LineWidthA : integer; width : integer) : double;
...
function MatrixLinEQSolve(A : PDouble; const LineWidthA : integer; width : integer; B : PDouble; const LineWidthB : integer; X : PDouble; const LineWidthX : integer; Width2 : integer; const NumRefinments : integer) : TLinEquResult;
...
function MatrixSVDInPlace(A : PDouble; const LineWidthA : integer; width : integer; Height : integer; W : PDouble; const LineWidthW : integer;
                           V : PDouble; const LineWidthV : integer) : TSVDResult;
...
function MatrixCholeskyInPlace(A : PDouble; const LineWidthA : integer; width : integer; P : PDouble; LineWidthP : integer) : TCholeskyResult;
function MatrixCholesky(dest : PDouble; const LineWidthDest : integer; A : PDouble; const LineWidthA : integer; width : integer;
  P : PDouble; const LineWidthP : integer) : TCholeskyResult;
...
function MatrixQRDecompInPlace(A : PDouble; const LineWidthA : integer; width : integer; C : PDouble; const LineWidthC : integer;
  D : PDouble; const LineWidthD : integer) : TQRResult;
function MatrixQRDecomp(dest : PDouble; const LineWidthDest : integer; A : PDouble; const LineWidthA : integer; width : integer;
  C : PDouble; const LineWidthC : integer; D : PDouble; const LineWidthD : integer) : TQRResult;
...
procedure MatrixQRSolveLinEq(A : PDouble; const LineWidthA : integer; width : integer; C : PDouble; const LineWidthC : integer;
  D : PDouble; const LineWidthD : integer; B : PDouble; const LineWidthB : integer);
...
function MatrixPseudoinverse(dest : PDouble; const LineWidthDest : integer; X : PDouble; const LineWidthX : integer;
  width, height : integer) : TSVDResult;


implementation

uses Math, MathUtilFunc, OptimizedFuncs;
...
begin
     ...
     Result := MatrixSVDInPlace(X, lineWidthX, width, height, @S[0], sizeof(double), @V[0], lineWidthV);
     ...
     begin
          ...
          begin
               ...
               inc(PAnsiChar(dest), LineWidthDest);
               inc(PAnsiChar(pRes), sizeof(double)*height);
          end;
     end;
end;
...
begin
     ...
     begin
          ...
          inc(PAnsiChar(PInvA), LineWidthInvA);
          inc(PAnsiChar(A), LineWidthA);
          Move(B^, PX^, sizeof(double)*m);
          inc(PAnsiChar(B), LineWidthB);
          inc(PAnsiChar(PX), LineWidthX);
     end;

     Result := MatrixGaussJordaninPlace(invA, lineWidthInvA, X, LineWidthX, width, m, epsilon);
end;

function MatrixGaussJordanInPlace(A : PDouble; const LineWidthA : integer; B : PDouble; const LineWidthB : integer; width : integer; m : integer; const epsilon : double) : TLinEquResult;
...
function InternalMatrixLUDecompInPlace(A : PDouble; const LineWidthA : Integer; width : integer; indx : PIntegerArray; var parity : double) : TLinEquResult;
...
begin
     ...
     begin
          big := 0;
          pVal := PDouble(PAnsiChar(A) + LineWidthA*i);
     ...
     begin
          ...
          begin
               sum := pVal^;
               pSum1 := PDouble(PAnsiChar(A) + i*LineWidthA);
               pSum2 := A;
               inc(pSum2, j);
               for k := 0 to i - 1 do
               begin
                    sum := sum - pSum1^*pSum2^;
                    inc(pSum1);
                    inc(PAnsiChar(pSum2), LineWidthA);
               end;

               pVal^ := sum;
               inc(PAnsiChar(pVal), LineWidthA);
          end;

          big := 0;
          for i := j to width - 1 do
          begin
               pVal := PDouble(PAnsiChar(A) + i*LineWidthA);
               inc(pVal, j);
               sum := pVal^;
               pSum1 := PDouble(PAnsiChar(A) + i*LineWidthA);
               pSum2 := A;
          ...
          if j <> imax then
          begin
               pSum1 := PDouble(PAnsiChar(A) + imax*LineWidthA);
               pSum2 := PDouble(PAnsiChar(A) + j*LineWidthA);
               Move(pSum1^, row[0], sizeof(double)*width);
               Move(pSum2^, pSum1^, sizeof(double)*width);
               Move(row[0], pSum2^, sizeof(double)*width);
          ...
          // number for zero
          pVal := PDouble(PAnsiChar(A) + j*LineWidthA);
          inc(pVal, j);
          if pVal^ = 0 then
             pVal^ := cDefEpsilon;
...
var parity : double;
begin
     Result := InternalMatrixLUDecompInPlace(A, LineWidthA, width, indx, parity);
end;

function MatrixLUDecomp(A : PDouble; const LineWidthA : integer; LUDecomp : PDouble; const LineWidthLU : integer; width : integer; indx : PIntegerArray) : TLinEquResult;
var i: Integer;
    PLU : PDouble;
begin
     Assert(width > 0, 'Dimension Error');
     ...
     for i := 0 to width - 1 do
     begin
          Move(A^, PLU^, sizeof(double)*width);
          inc(PAnsiChar(A), LineWidthA);
          inc(PAnsiChar(PLU), LineWidthLU);
     end;

     Result := MatrixLUDecompInPlace(LUDecomp, lineWidthLU, width, indx);
end;

function MatrixLUDecomp(A : PDouble; const LineWidthA : integer; LUDecomp : PDouble; const LineWidthLU : integer; width : integer) : TLinEquResult;
var indx : array of integer;
begin
     Assert(width > 0, 'Dimension Error');
     setLength(indx, width);

     Result := MatrixLUDecomp(A, LineWidthA, LUDecomp, LineWidthLU, width, @indx[0]);
end;
...
begin
     ...
     begin
          ip := indx[i];
          pB := B;
          inc(PAnsiChar(pB), ip*LineWidthB);
          sum := pB^;
          pB^ := pB2^;
          ...
          begin
               ...
               inc(pVal, ii);
               pB := B;
               inc(PAnsiChar(pB), LineWidthB*ii);
               for j := ii to i - 1 do
               begin
                    sum := sum - pVal^*pB^;
                    inc(pVal);
                    inc(PAnsiChar(pB), LineWidthB);
               end;
          end
          else if sum <> 0
          then
          ...
          pB2^ := sum;
          inc(PAnsiChar(pB2), LineWidthB);
     end;

     pB := B;
     inc(PAnsiChar(pB), LineWidthB*(width - 1));
     ...
     begin
          ...
          dec(pVal);
          dec(PAnsiChar(pVal), LineWidthLU);
          dec(PAnsiChar(pB), LineWidthB);
     end;
end;

function MatrixInverseInPlace(A : PDouble; const LineWidthA : integer; width : integer) : TLinEquResult;
var Y : TDoubleDynArray;
...
begin
     ...
     for i := 0 to Width - 1 do
     begin
          Move(pVal^, Y[i*width], sizeof(double)*width);
          inc(PAnsiChar(pVal), LineWidthA);
     end;

     Result := MatrixLUDecompInPlace(@Y[0], width*sizeof(double), width, @indx[0]);
     ...
     begin
          ...
          for i := 0 to width - 1 do
              col[i] := 0;
          col[j] := 1;
          MatrixLUBackSubst(@Y[0], width*sizeof(double), width, @indx[0], @col[0], sizeof(double));
...
begin
     ...
     for i := 0 to width - 1 do
     begin
          Move(pVal^, LUDecomp[i*width], sizeof(double)*width);
          inc(PAnsiChar(pVal), LineWidthA);
     end;

     if InternalMatrixLUDecompInPlace(@LUDecomp[0], width*sizeof(double), width, @indx[0], Result) = leSingular then
     begin
          Result := 0;
          exit;
     end;
     ...
     begin
          Result := Result * pVal^;
          inc(pVal);
          inc(PAnsiChar(pVal), width*sizeof(double));
     end;
end;

function MatrixLinEQSolve(A : PDouble; const LineWidthA : integer; width : integer; B : PDouble; const LineWidthB : integer; X : PDouble;
 const LineWidthX : integer;  Width2 : integer; const NumRefinments : integer) : TLinEquResult;
var indx : Array of Integer;
...
begin
     SetLength(LUDecomp, width*width);
     SetLength(indx, width);
     Result := MatrixLUDecomp(A, LineWidthA, @LUDecomp[0], width*sizeof(double), width, @indx[0]);
...
begin
     ...
     begin
          ...
          begin
               ...
               begin
                    ...
                    begin
                         ...
                         pA := pAi;
                         inc(pA, l);
                         inc(PAnsiChar(pAj), LineWidthA*j);
          ...
          inc(PAnsiChar(pWi), LineWidthW);
          inc(PAnsiChar(pAi), LineWidthA);
     end;

     // accumulation of right-hand transformations
     pAi := A;
     inc(PAnsiChar(pAi), (width - 1)*LineWidthA);
     for i := width - 1 downto 0 do
     begin
          if i < width - 1 then
          begin
               ...
               begin
                    ...
                    begin
                         ...
                         pVj := V;
                         inc(pVj, j);
                         inc(PAnsiChar(pVj), LineWidthV*l);

                         for k := l to width - 1 do
                         begin
                              pVj^ := pVj^ + s*pV^;
                              inc(PAnsiChar(pVj), LineWidthV);
                              inc(PAnsiChar(pV), LineWidthV);
                         end;
                    end;
               end;  // end if g <> 0
          ...
          dec(PAnsiChar(pAi), LineWidthA);
     end;

     pWi := W;
     inc(PAnsiChar(pWi), (min(width, height) - 1)*LineWidthW);
     pAi := A;
     inc(PAnsiChar(pAi), (min(width, height) - 1)*LineWidthA);
     ...
     begin
          ...
          begin
               ...
               begin
                    ...
                    pA := A;
                    inc(pA, i);
                    inc(PAnsiChar(pA), l*LineWidthA);
                    pAj := A;
                    inc(pAj, j);
                    inc(PAnsiChar(pAj), l*LineWidthA);
...
begin
     ...
     begin
          ...
          inc(PAnsiChar(pA), LineWidthA);
          inc(PAnsiChar(pU), LineWidthU);
     end;

     Result := MatrixSVDInPlace(U, LineWidthU, width, Height, W, LineWidthW, V, LineWidthV);
end;
...
function MatrixCholesky(dest : PDouble; const LineWidthDest : integer; A : PDouble; const LineWidthA : integer; width : integer; P : PDouble; const LineWidthP : integer) : TCholeskyResult;
var pDest : PDouble;
    pA : PDouble;
    i : integer;
begin
     ...
     begin
          ...
          inc(PAnsiChar(pDest), LineWidthDest);
          inc(PAnsiChar(pA), LineWidthA);
     end;

     Result := MatrixCholeskyInPlace(dest, LineWidthDest, width, P, LineWidthP);
end;
...
begin
     ...
     begin
          ...
          begin
               pX := pXi;
               dec(PAnsiChar(pX), LineWidthX);
               pA := A;
               inc(PAnsiChar(pA), i*LineWidthA);
               inc(pA, i - 1);
               for k := i - 1 downto 0 do
               begin
                    sum := sum - pA^*pX^;
          ...
          inc(PAnsiChar(pB), LineWidthB);
          inc(PAnsiChar(pP), LineWidthP);
          inc(PAnsiChar(pXi), LineWidthX);
     end;

     // Solve L' * x = y
     pP := P;
     inc(PAnsiChar(pP), (width - 1)*LineWidthP);
     pXi := X;
     inc(PAnsiChar(pXi), (width - 1)*LineWidthX);
     for i := width - 1 downto 0 do
     begin
          sum := pXi^;
          pX := pXi;
          ...
          begin
               ...
               pA := A;
               inc(pA, i);
               inc(PAnsiChar(pA), (i + 1)*LineWidthA);
          ...
          pXi^ := sum/pP^;
          dec(PAnsiChar(pP), LineWidthP);
          dec(PAnsiChar(pXi), LineWidthX); 
     end;
end;
...
begin
     ...
     begin
          ...
          inc(PAnsiChar(pC), LineWidthC);
          inc(PAnsiChar(pD), LineWidthD);
          inc(pAk);
          inc(PAnsiChar(pAk), LineWidthA);
     end;

     pD := D;
     inc(PAnsiChar(pD), (width - 1)*LineWidthD);
     pA := A;
     inc(pA, width - 1);
     inc(PAnsiChar(pA), (width - 1)*LineWidthA);
     pD^ := pA^;
     if pD^ = 0 then
        Result := qrSingular;
end;
...
begin
     ...
     Result := MatrixQRDecompInPlace(dest, LineWidthDest, width, C, LineWidthC, D, LineWidthD);
end;
...
begin
     pBj := B;
     inc(PAnsiChar(pBj), LineWidthB*(width - 1));
     pD := D;
     inc(PAnsiChar(pD), LineWidthD*(width - 1));
     pBj^ := pBj^/pD^;
     pAj := A;
     inc(PAnsiChar(pAj), (width - 2)*LineWidthA);
     inc(pAj, (width - 1));
     ...
     begin
          ...
          dec(PAnsiChar(pBj), LineWidthB);
          dec(PAnsiChar(pD), LineWidthD);
          pBj^ := (pBj^ - sum)/pD^;

          dec(pAj);
          dec(PAnsiChar(pAj), LineWidthA);
     end;
end;
...
begin
     ...
     begin
          ...
          inc(PAnsiChar(pAj), LineWidthA);
          inc(PAnsiChar(pC), LineWidthC);
          inc(PAnsiChar(pBj), LineWidthB);
     end;

     MatrixRSolve(A, LineWidthA, width, C, LineWidthC, D, LineWidthD, B, LineWidthB);
end;
