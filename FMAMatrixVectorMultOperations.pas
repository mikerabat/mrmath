...
asm
   ...
   @@foryloop:
       ...
       @@forxloop:
           ...
           vfmadd231pd ymm0, ymm4, [eax];
           vfmadd231pd ymm1, ymm4, [eax + esi];
           vfmadd231pd ymm2, ymm4, [eax + 2*esi];
           add eax, esi;
           vfmadd231pd ymm3, ymm4, [eax + 2*esi];
           sub eax, esi;
