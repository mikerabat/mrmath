...
asm
   ...
   lea edi, dOffset;
   {$IFDEF AVXSUP}vbroadcastsd ymm3, [edi];                           {$ELSE}db $C4,$E2,$7D,$19,$1F;{$ENDIF} 
   lea edi, scale;
   {$IFDEF AVXSUP}vbroadcastsd ymm4, [edi];                           {$ELSE}db $C4,$E2,$7D,$19,$27;{$ENDIF} 
   ...
   @@addforyloop:
       ...
       @addforxloop:
           ...
           // add mul
           {$IFDEF AVXSUP}vmovapd ymm0, [eax + edi - 128];            {$ELSE}db $C5,$FD,$28,$44,$38,$80;{$ENDIF} 
           {$IFDEF AVXSUP}vaddpd ymm0, ymm0, ymm3;                    {$ELSE}db $C5,$FD,$58,$C3;{$ENDIF} 
           {$IFDEF AVXSUP}vmulpd ymm0, ymm0, ymm4;                    {$ELSE}db $C5,$FD,$59,$C4;{$ENDIF} 
           ...
           {$IFDEF AVXSUP}vmulpd ymm2, ymm2, ymm4;                    {$ELSE}db $C5,$ED,$59,$D4;{$ENDIF} 
           {$IFDEF AVXSUP}vmovapd [eax + edi - 96], ymm2;             {$ELSE}db $C5,$FD,$29,$54,$38,$A0;{$ENDIF} 

           {$IFDEF AVXSUP}vmovapd ymm0, [eax + edi - 64];             {$ELSE}db $C5,$FD,$28,$44,$38,$C0;{$ENDIF} 
           {$IFDEF AVXSUP}vaddpd ymm0, ymm0, ymm3;                    {$ELSE}db $C5,$FD,$58,$C3;{$ENDIF} 
           {$IFDEF AVXSUP}vmulpd ymm0, ymm0, ymm4;                    {$ELSE}db $C5,$FD,$59,$C4;{$ENDIF} 
           {$IFDEF AVXSUP}vmovapd [eax + edi - 64], ymm0;             {$ELSE}db $C5,$FD,$29,$44,$38,$C0;{$ENDIF} 

           {$IFDEF AVXSUP}vmovapd ymm2, [eax + edi - 32];             {$ELSE}db $C5,$FD,$28,$54,$38,$E0;{$ENDIF} 
           {$IFDEF AVXSUP}vaddpd ymm2, ymm2, ymm3;                    {$ELSE}db $C5,$ED,$58,$D3;{$ENDIF} 
           {$IFDEF AVXSUP}vmulpd ymm2, ymm2, ymm4;                    {$ELSE}db $C5,$ED,$59,$D4;{$ENDIF} 
           {$IFDEF AVXSUP}vmovapd [eax + edi - 32], ymm2;             {$ELSE}db $C5,$FD,$29,$54,$38,$E0;{$ENDIF} 
       ...
       @addforxloop2:
           {$IFDEF AVXSUP}vmovapd xmm0, [eax + edi];                  {$ELSE}db $C5,$F9,$28,$04,$38;{$ENDIF} 
           {$IFDEF AVXSUP}vaddpd xmm0, xmm0, xmm3;                    {$ELSE}db $C5,$F9,$58,$C3;{$ENDIF} 
           {$IFDEF AVXSUP}vmulpd xmm0, xmm0, xmm4;                    {$ELSE}db $C5,$F9,$59,$C4;{$ENDIF} 

           {$IFDEF AVXSUP}vmovapd [eax + edi], xmm0;                  {$ELSE}db $C5,$F9,$29,$04,$38;{$ENDIF} 
       add edi, 16;
       jnz @addforxloop2;
...
asm
   ...
   @@addforyloop:
       ...
       @addforxloop:
           ...
           // add mul
           {$IFDEF AVXSUP}vmovupd ymm0, [eax + edi - 128];            {$ELSE}db $C5,$FD,$10,$44,$38,$80;{$ENDIF} 
           {$IFDEF AVXSUP}vaddpd ymm0, ymm0, ymm3;                    {$ELSE}db $C5,$FD,$58,$C3;{$ENDIF} 
           {$IFDEF AVXSUP}vmulpd ymm0, ymm0, ymm4;                    {$ELSE}db $C5,$FD,$59,$C4;{$ENDIF} 
           ...
           {$IFDEF AVXSUP}vmovupd ymm0, [eax + edi - 64];             {$ELSE}db $C5,$FD,$10,$44,$38,$C0;{$ENDIF} 
           {$IFDEF AVXSUP}vaddpd ymm0, ymm0, ymm3;                    {$ELSE}db $C5,$FD,$58,$C3;{$ENDIF} 
           {$IFDEF AVXSUP}vmulpd ymm0, ymm0, ymm4;                    {$ELSE}db $C5,$FD,$59,$C4;{$ENDIF} 
           {$IFDEF AVXSUP}vmovupd [eax + edi - 64], ymm0;             {$ELSE}db $C5,$FD,$11,$44,$38,$C0;{$ENDIF} 

           {$IFDEF AVXSUP}vmovupd ymm2, [eax + edi - 32];             {$ELSE}db $C5,$FD,$10,$54,$38,$E0;{$ENDIF} 
           {$IFDEF AVXSUP}vaddpd ymm2, ymm2, ymm3;                    {$ELSE}db $C5,$ED,$58,$D3;{$ENDIF} 
           {$IFDEF AVXSUP}vmulpd ymm2, ymm2, ymm4;                    {$ELSE}db $C5,$ED,$59,$D4;{$ENDIF} 
           {$IFDEF AVXSUP}vmovupd [eax + edi - 32], ymm2;             {$ELSE}db $C5,$FD,$11,$54,$38,$E0;{$ENDIF} 
       ...
       @addforxloop2:
           {$IFDEF AVXSUP}vmovupd xmm0, [eax + edi];                  {$ELSE}db $C5,$F9,$10,$04,$38;{$ENDIF} 
           {$IFDEF AVXSUP}vaddpd xmm0, xmm0, xmm3;                    {$ELSE}db $C5,$F9,$58,$C3;{$ENDIF} 
           {$IFDEF AVXSUP}vmulpd xmm0, xmm0, xmm4;                    {$ELSE}db $C5,$F9,$59,$C4;{$ENDIF} 

           {$IFDEF AVXSUP}vmovupd [eax + edi], xmm0;                  {$ELSE}db $C5,$F9,$11,$04,$38;{$ENDIF} 
       add edi, 16;
       jnz @addforxloop2;
...
// prolog - simulate stack
   ...
   @@addforyloop:
       ...
       {$IFDEF AVXSUP}vmovsd xmm0, [eax];                             {$ELSE}db $C5,$FB,$10,$00;{$ENDIF} 
       {$IFDEF AVXSUP}vaddsd xmm0, xmm0, xmm3;                        {$ELSE}db $C5,$FB,$58,$C3;{$ENDIF} 
       {$IFDEF AVXSUP}vmulsd xmm0, xmm0, xmm4;                        {$ELSE}db $C5,$FB,$59,$C4;{$ENDIF} 
