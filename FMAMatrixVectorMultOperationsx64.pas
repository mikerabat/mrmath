...
asm
   ...
   @@foryloop:
       ...
       @@forxloop:
           ...
           {$IFDEF AVXSUP}vfmadd231pd ymm0, ymm4, [rax];              {$ELSE}db $C4,$E2,$DD,$B8,$00;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm1, ymm4, [rax + rsi];        {$ELSE}db $C4,$E2,$DD,$B8,$0C,$30;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm2, ymm4, [rax + 2*rsi];      {$ELSE}db $C4,$E2,$DD,$B8,$14,$70;{$ENDIF} 
           add rax, rsi;
           {$IFDEF AVXSUP}vfmadd231pd ymm3, ymm4, [rax + 2*rsi];      {$ELSE}db $C4,$E2,$DD,$B8,$1C,$70;{$ENDIF} 
           sub rax, rsi;
...
asm
   ...
   @@foryloop:
       ...
       @@forxloop:
           ...
           {$IFDEF AVXSUP}vfmadd231pd ymm0, ymm4, ymm5;               {$ELSE}db $C4,$E2,$DD,$B8,$C5;{$ENDIF} 

           {$IFDEF AVXSUP}vmovupd ymm5, [rax + rsi];                  {$ELSE}db $C5,$FD,$10,$2C,$30;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm1, ymm4, ymm5;               {$ELSE}db $C4,$E2,$DD,$B8,$CD;{$ENDIF} 

           {$IFDEF AVXSUP}vmovupd ymm5, [rax + 2*rsi];                {$ELSE}db $C5,$FD,$10,$2C,$70;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm2, ymm4, ymm5;               {$ELSE}db $C4,$E2,$DD,$B8,$D5;{$ENDIF} 

           add rax, rsi;
           {$IFDEF AVXSUP}vmovupd ymm5, [rax + 2*rsi];                {$ELSE}db $C5,$FD,$10,$2C,$70;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm3, ymm4, ymm5;               {$ELSE}db $C4,$E2,$DD,$B8,$DD;{$ENDIF} 
           sub rax, rsi;
...
asm
   ...
   @@forxloop:
       ...
       @@foryloop:
           ...
           {$IFDEF AVXSUP}vfmadd231pd ymm8, ymm3, ymm4;               {$ELSE}db $C4,$62,$E5,$B8,$C4;{$ENDIF} 

           {$IFDEF AVXSUP}vmovupd ymm4, [rax + 32];                   {$ELSE}db $C5,$FD,$10,$60,$20;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm9, ymm3, ymm4;               {$ELSE}db $C4,$62,$E5,$B8,$CC;{$ENDIF} 

           {$IFDEF AVXSUP}vmovupd ymm4, [rax + 64];                   {$ELSE}db $C5,$FD,$10,$60,$40;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm10, ymm3, ymm4;              {$ELSE}db $C4,$62,$E5,$B8,$D4;{$ENDIF} 

           {$IFDEF AVXSUP}vmovupd ymm4, [rax + 96];                   {$ELSE}db $C5,$FD,$10,$60,$60;{$ENDIF} 
           {$IFDEF AVXSUP}vfmadd231pd ymm11, ymm3, ymm4;              {$ELSE}db $C4,$62,$E5,$B8,$DC;{$ENDIF} 
...
asm
   ...
   @@foryloop:
      ...
      @@forxloop:
         ...
         // pA^[j] := pA^[j] + tmp*pY1^[j];
         {$IFDEF AVXSUP}vfmadd231pd ymm1, ymm0, ymm2;                 {$ELSE}db $C4,$E2,$FD,$B8,$CA;{$ENDIF} 
      ...
      {$IFDEF AVXSUP}vfmadd231pd xmm1, xmm0, xmm2;                    {$ELSE}db $C4,$E2,$F9,$B8,$CA;{$ENDIF} 
